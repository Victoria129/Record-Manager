...
RSpec.describe Book do
    before (:each) do
        @book1 = Book.new(publisher: "Amazon", cover_state: "Good", genre: "Vintage", author: "Agatha Christie", source: "Bookstore", label: "Classic", publish_date: "1982-03-11")
        @book2 = Book.new(publisher: "Penguin", cover_state: "Bad", genre: "Fiction", author: "Jane Austen", source: "Library", label: "Bestseller", publish_date: "2000-01-28")
    end
